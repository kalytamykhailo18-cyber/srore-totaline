    ...
    <nav className="bg-brand-800 text-white sticky top-0 z-50 shadow-lg">
      <div className="max-w-7xl mx-auto px-4">
        <div className="flex items-center justify-between h-16">
          ...
          {/* Categorías button — mobile only (between logo and cart) */}
          <button
            onClick={() => window.dispatchEvent(new CustomEvent("openCategoriesSidebar"))}
            className="md:hidden flex items-center gap-1.5 px-3 py-2 bg-white/15 hover:bg-white/25 rounded-lg text-sm font-medium transition-colors"
          >
